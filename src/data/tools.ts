...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    seoTitle: 'Prompt Library - 21 Ready AI Prompts | PromptForge',
    ...
    intro: 'Twenty-one field-tested prompts across five categories. Copy one, replace the [BRACKETS] with your material, and paste it into your AI tool.',
